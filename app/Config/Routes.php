...
$routes->post('api/reset-user-password', 'api\Users::reset_user_password');
...
$routes->post('api/admin/load-pending-rfa-transactions-data','api\PendingRFATransactions::load_pending_rfa_transactions_data');
...
$routes->post('api/admin/load-pending-transactions-data', 'api\PendingTransactions::load_pending_transactions_data');
