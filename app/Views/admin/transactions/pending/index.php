                                             ...
                                             <div class="col-lg-12 mt-sm-30 mt-xs-30">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <canvas id="most-pending-chart" ></canvas>
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
...
$(document).on('click', 'a.completed', function (e) {
   ...
   var p_number = $(this).data('pmas-number')
   Swal.fire({
      title: "Are you sure?",
      text: "",
      icon: "warning",
...
function load_most_pending_chart() {
   $.ajax({
      url: base_url + 'api/admin/load-pending-transactions-data',
      data: {
         data : data
      },
      method: 'POST',
      ...
      success: function (data) {
         try {
            new Chart(document.getElementById("most-pending-chart"), {
