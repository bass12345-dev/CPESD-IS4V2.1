...
class Users extends BaseController
{
    ...
    public function get_user_active(){
        ...
        foreach ($item as $row) {
            ...
            if ($row->user_type == 'admin') {
                ...
                $a = '<ul class="d-flex justify-content-center"><li class="mr-1"><a href="javascript:;" data-id="'.$row->user_id.'" id="view_user"  class="text-secondary action-icon"><i class="ti-eye"></i></a></li><li><a href="javascript:;" data-id="'.$row->user_id.'"  id="delete-user" data-set="inactive" class="text-danger action-icon"><i class="ti-close"></i></a></li><li><a href="javascript:;" data-id="'.$row->user_id.'"  id="set-default-password" class="text-warning action-icon"><i class="fa fa-key"></i></a></li></ul>';
            }
    ...
    public function update_password(){
        ...
        $where  = array('user_id' => $this->request->getPost('user_id'));
         ...
         $data = array(
          ...
          $this->func_update_password($where,$data,$this->users_table);
   ...
   function func_update_password($where,$data,$table){
