...
public function load_pending_transactions_data(){
        ...
        foreach($items as $row) {
            ...
            $pending = $this->CustomModel->countwhere($this->transactions_table,array('transaction_status' => 'pending','created_by' => $row->user_id ));
